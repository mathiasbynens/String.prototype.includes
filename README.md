# ES6 `String.prototype.contains` polyfill [![Build status](https://travis-ci.org/mathiasbynens/String.prototype.contains.svg?branch=master)](https://travis-ci.org/mathiasbynens/String.prototype.contains)
